        ...
        <Box sx={{display: 'flex'}}>
            ...
            <AppBar position="fixed" open={open}>
                <Toolbar>
                    ...
                    <Typography variant="h6" noWrap component="div" color={'primary'} fontWeight={'bolder'}>
                        Task X
                    </Typography>
                    <Box sx={{flexGrow: 1}}/>
            ...
            <AppDrawer variant="permanent" open={open}>
                ...
                <Divider/>
                <List>
                    {allRoute.filter(r => r.showInMenu).map((r) => (
                        <ListItem key={r.path} disablePadding sx={{display: 'block'}}>
                            ...
                            >
                                ...
                                <ListItemText primary={r.text} sx={{opacity: open ? 1 : 0}}/>
                            </ListItemButton>
                        </ListItem>
                    ))}
                </List>
            ...
            <Box component="main" sx={{flexGrow: 1}}>
                <DrawerHeader/>
                <Box display={'flex'} sx={{flexGrow: 1, p: 1}}>
                    {children}
                </Box>
            </Box>
        </Box>
